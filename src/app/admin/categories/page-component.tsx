  ...
  > = async data => {
    ...
    switch (intent) {
      case 'create': {
        ...
        if (imageUrl) {
          await createCategory({ imageUrl, name }); //name: data.name
          form.reset();
          router.refresh();
      ...
      default:
        console.error('Intención no válida');
    }
  };
          ...
          <Table className='min-w-[600px]'>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className='md:table-cell'>Fecha de creación</TableHead>
                <TableHead className='md:table-cell'>Productos</TableHead>
                <TableHead>
