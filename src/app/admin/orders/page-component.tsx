...
const statusOptions = ['Pendiente',  'Completado', 'Incompleto'];
...
export default function PageComponent({ ordersWithProducts }: Props) {
  ...
  return (
    <div className='container mx-auto p-6'>
      <h1 className='text-2xl font-bold mb-6'>Panel de gestión de pedidos</h1>
      <Table>
        <TableHeader>
          <TableRow>
        ...
        <TableBody>
          {ordersWithProducts.map(order => (
            <TableRow key={order.id}>
              ...
              <TableCell>Bs {order.totalPrice.toFixed(2)}</TableCell>
              <TableCell>
              ...
              <TableCell>
                <Dialog>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      <DialogTitle>Productos pedidos</DialogTitle>
                    </DialogHeader>
                      ...
                      {selectedProducts.map(({ product }, index) => (
                        ...
                        >
                          ...
                          <div className='flex flex-col'>
                            ...
                            Cantidad disponible: {product.maxQuantity}
                            </span>
                          </div>
                        </div>
                      ))}
